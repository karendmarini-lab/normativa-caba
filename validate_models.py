...
# 45 professional studies (m²v from prefactibilidad images)
REMAX_STUDIES = [
    ("10-8-11E", 9280), ("12-44-21", 3326), ("12-51-36", 2670),
    ("12-54-9", 2890), ("12-72-8", 1815), ("16-37-21", 1619),
    ("17-1-12B", 3166), ("17-36-23", 1425), ("17-45-6", 1676),
    ("17-71-11A", 863), ("17-94-36A", 4397), ("18-110-11", 1537),
    ("18-140-9", 1217), ("19-3-36", 2065), ("22-18-20", 5773),
    ("22-27-27", 1301), ("22-33-32", 5013), ("24-26-17", 978),
    ("25-19-2C", 1363), ("30-7-13", 1055), ("30-96-38", 1465),
    ("31-63-26", 1285), ("35-115-34", 2682), ("36-24-46", 3621),
    ("37-21-13", 2123), ("40-134-17", 892), ("41-113-4", 1339),
    ("41-89-30A", 1430), ("43-101B-3", 592), ("43-159-25", 954),
    ("47-101-23", 945), ("47-101-26", 874), ("47-125-28A", 675),
    ("47-143-26", 690), ("48-117-14", 4634), ("5-23-1A", 1042),
    ("5-5-33", 1645), ("55-216-13", 599), ("66-47-2", 1785),
    ("71-35-21", 1400), ("71-53-24", 1000), ("83-207-2A", 982),
    ("85-22-40D", 760), ("85-24-18", 527), ("89-12-4", 430),
]
